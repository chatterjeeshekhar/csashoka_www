...
Tags:the events calendar, event, shortcode, calendar, timeline, template, modern tribe, theeventscalendar, events shortcode, calendar addon, the events calendar addon, events calendar templates, events timeline, events block
...
* Create events by using WordPress most powerful **calendar plugin** - [The Events Calendar](https://wordpress.org/plugins/the-events-calendar/) - **700,000+ Active Users**.
* Then install this **calendar addon** and it will provide a functionality to extend the design of your events listing page by using our gorgeous **events design templates**.
* You can also easily show your upcoming events or past events anywhere on your page by using our flexible & intuitive **block / shortcode builder for the events calendar**.
...
= Events Single(details)Page Template Free Addon =
* [The Events Calendar Event Details Page Templates](https://eventscalendartemplates.com/event/wordpress-chandigarh-meetup-free-ticket-2018/)
